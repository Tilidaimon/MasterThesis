function [Ug,assign_plan] = HCGFunctionSAP(epsilon, model, Epis, initial_plan)
...
for i = 1:TargetNum
    coAgentNums(i) = sum(assign_plan==i);
end
...
for t = 1:T
    ...
    best_task = assign_plan(i); % current task of agent i
    if best_task == 0
        curUtility = 0;
    else
