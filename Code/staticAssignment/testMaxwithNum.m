...
for Nm = 10:10:100
    ...
    index = Nm/10;
    JSFP_mean_max(index) = mean(JSFP_max);
    GRM_mean_max(index) = mean(GRM_max);
    SAP_mean_max(index) = mean(SAP_max);
    PSO_mean_max(index) = mean(PSO_max);
    ACO_mean_max(index) = mean(ACO_max);
    SAGA_mean_max(index) = mean(SAGA_max);
    GA_mean_max(index) = mean(GA_max);
    IGA_mean_max(index) = mean(IGA_max);
