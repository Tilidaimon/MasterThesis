...
% 归一化
maxU = max([JSFP_global_save,GRM_global_save,SAP_global_save,PSO_global_save,SAGA_global_save,ACO_global_save,GA_global_save,IGA_global_save]);

JSFP_global_save = JSFP_global_save/maxU;
SAGA_global_save = SAGA_global_save/maxU;
SAP_global_save = SAP_global_save/maxU;
...
IGA_global_save = IGA_global_save/maxU;


algo_cell = {'JSFP';'GRM';'SAP';'ACO';'PSO';'GA';'IGA';'SAGA'};
[l,~]=size(algo_cell);
filename = [num2str(model.num_missiles),'vs',num2str(model.num_targets),'/Convergence/'];
for i=1:l
